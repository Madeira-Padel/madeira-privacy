...
يجب أن تدرك أن هناك أشياء معينة لن تتحمل "ماديرا باديل" مسؤوليتها. تتطلب بعض وظائف التطبيق أن يكون للتطبيق اتصال إنترنت نشط. يمكن أن يكون الاتصال عبر Wi-Fi أو مقدمًا من مزود شبكة الهاتف المحمول الخاص بك، ولكن لا تتحمل ماديرا بادل مسؤولية التطبيق الذي لا يعمل بكامل وظائفه إذا لم يكن لديك وصول إلى شبكة Wi-Fi، ولم يكن لديك خدمة بيانات.
...
على نفس المنوال، لا تتحمل ماديرا بادل دائمًا مسؤولية الطريقة التي تستخدم بها التطبيق، أي أنك تحتاج إلى التأكد من بقاء جهازك مشحونًا - إذا نفدت البطارية ولا يمكنك تشغيله للاستفادة من الخدمة، لا يمكن لـ ماديرا بادل قبول المسؤولية.

فيما يتعلق بمسؤولية ماديرا بادل عن استخدامك للتطبيق، عند استخدامك للتطبيق، من المهم أن تضع في اعتبارك أنه على الرغم من أننا نسعى لضمان تحديثه وصحته في جميع الأوقات، فإننا نعتمد على الجهات الخارجية من أجل تزويدنا بالمعلومات حتى نتمكن من إتاحتها لك. لا تتحمل ماديرا بادل أي مسؤولية عن أي خسارة، مباشرة أو غير مباشرة، تتعرض لها نتيجة الاعتماد كليًا على وظيفة التطبيق هذه.

في مرحلة ما، قد نرغب في تحديث التطبيق. التطبيق متاح حاليًا على نظامي Android و iOS - قد تتغير متطلبات كلا النظامين (وأي أنظمة إضافية نقرر تمديد توفر التطبيق عليها)، وستحتاج إلى تنزيل التحديثات إذا كنت تريد الاحتفاظ بها باستخدام التطبيق. لا تعد ماديرا بادل بأنها ستقوم دائمًا بتحديث التطبيق بحيث يكون مناسبًا لك و / أو يعمل مع إصدار Android و iOS الذي قمت بتثبيته على جهازك. ومع ذلك، فإنك تتعهد بقبول تحديثات التطبيق دائمًا عند عرضها عليك، وقد نرغب أيضًا في التوقف عن توفير التطبيق، وقد ننهي استخدامه في أي وقت دون إرسال إشعار بالإنهاء إليك. ما لم نخبرك بخلاف ذلك، عند أي إنهاء، (أ) تنتهي الحقوق والتراخيص الممنوحة لك في هذه الشروط ؛ (ب) يجب عليك التوقف عن استخدام التطبيق، و (إذا لزم الأمر) حذفه من جهازك.
...
تسري هذه الشروط والأحكام اعتبارًا من 2022-05-30

اتصل بنا

إذا كان لديك أي أسئلة أو اقتراحات حول الشروط والأحكام الخاصة بنا ، فلا تتردد في الاتصال بنا على madeirapadel2022@gmail.com.

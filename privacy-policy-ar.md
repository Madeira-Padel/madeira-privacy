...
إيمانًا منا برفعك وتطلعاتك للأفضل وسعيًا لتحقيق رغباتك وامتنانًا وتقديرًا لثقتك في ماديرا بادال، فإننا نعمل بجد لنكون عند توقعاتك في تقديم كل ما هو جديد ومفيد لك و الحفاظ على خصوصيتك بأقصى قدر من الشفافية.
ستساعدك سياسة الخصوصية الخاصة بنا على فهم ماهي المعلومات التي نجمعها في Madeira Padel، وكيف تستخدمها Madeira Padel، وما هي الخيارات التي لديك. صممت Madira Padel تطبيق Madeira Padel كتطبيق مجاني. يتم توفير هذه الخدمة بواسطة Madeira Padel مجانًا وهي مخصصة للاستخدام كما هي. إذا اخترت استخدام خدمتنا ، فأنت توافق على جمع واستخدام المعلومات المتعلقة بهذه السياسة. تُستخدم المعلومات الشخصية التي نجمعها لتوفير الخدمة وتحسينها. لن نستخدم أو نشارك معلوماتك مع أي شخص باستثناء ما هو موضح في سياسة الخصوصية هذه.
...
للحصول على تجربة أفضل أثناء استخدام خدمتنا، قد نطلب منك تزويدنا بمعلومات تعريف شخصية معينة، بما في ذلك على سبيل المثال لا الحصر اسم المستخدم وعنوان البريد الإلكتروني ورقم الهاتف المحمول. سيتم الاحتفاظ بالمعلومات التي نطلبها من قبلنا واستخدامها كما هو موضح في سياسة الخصوصية هذه.
تستخدم Madeira Padel جميع المعلومات التي تم الحصول عليها لإبلاغ المشتركين بأي تحديثات وتغييرات تتعلق بحجوزاتهم، وذلك بالتنسيق معهم لضمان راحتهم وقناعتهم بإشراكهم في القرارات التي تتخذها لإرضاء جميع عملائها بما تقدمه لهم.
...
لأداء الخدمات المتعلقة بالخدمة؛ أولمساعدتنا في تحليل كيفية استخدام خدمتنا.
...
معلومات التواصل:
البريد الإلكتروني: madeirapadel2022@gmail.com
